  ...
  return (
    <main className='min-h-screen flex flex-col px-4 py-8 md:p-8'>
      <header className='mb-8'>
        <h1 className='text-white font-minecraft-title uppercase text-3xl md:text-5xl text-center'>Minecraft Users</h1>
        <p className='text-gray-200 text-center mt-2'>Visualizador de perfiles, skins y capas de jugadores de Minecraft</p>
      </header>
      <div className='max-w-7xl mx-auto w-full'>
        <div className='bg-[#1E1E1E]/50 border border-gray-800 rounded-lg p-4 md:p-6 mb-8'>
